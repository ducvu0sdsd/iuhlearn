...
const DoiMatKhauGiaoVien = () => {
    ...
    const handleConfirm = () => {
        ...
        api({
            type: TypeHTTP.POST, sendToken: true, path: '/auth/update-password-with-teacher', body: {
                id: globalData.teacher._id,
                oldPass,
                newPass
            }
        })
...
export default DoiMatKhauGiaoVien